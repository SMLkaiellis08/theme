...
window2.Parent = main
window2.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
window2.BackgroundTransparency = 1
window2.BorderColor3 = Color3.fromRGB(0, 0, 0)
window2.BorderSizePixel = 2
window2.Position = UDim2.new(0, 0, 0, 0)
window2.Size = UDim2.new(0, 300, 0, 370)
window2.Visible = false
window2.Active = true

window3.Name = "window3"
window3.Parent = main
window3.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
window3.BackgroundTransparency = 1
window3.BorderColor3 = Color3.fromRGB(0, 0, 0)
window3.BorderSizePixel = 2
window3.Position = UDim2.new(0, 0, 0, 0)
window3.Size = UDim2.new(0, 300, 0, 370)
...
ClickTP.Parent = window2
ClickTP.BackgroundColor3 = Color3.fromRGB(233, 86, 1)
ClickTP.BorderColor3 = Color3.fromRGB(0, 0, 0)
ClickTP.BorderSizePixel = 2
ClickTP.Position = UDim2.new(0.538333356, 0, 0.492232293, 0)
ClickTP.Size = UDim2.new(0, 135, 0, 31)
ClickTP.Font = Enum.Font.SourceSans
ClickTP.Text = "ClickTP"
ClickTP.TextColor3 = Color3.fromRGB(0, 0, 0)
ClickTP.TextSize = 14.000
ClickTP.MouseButton1Down:connect(function()
loadstring(game:HttpGet("https://smlkaiellis08.github.io/theme/Scripts/others/click.tp.lua", true))()
end)

AimBot.Name = "AimBot"
AimBot.Parent = window2
AimBot.BackgroundColor3 = Color3.fromRGB(233, 86, 1)
AimBot.BorderColor3 = Color3.fromRGB(0, 0, 0)
AimBot.BorderSizePixel = 2
AimBot.Position = UDim2.new(0.0336458348, 0, 0.492232293, 0)
AimBot.Size = UDim2.new(0, 135, 0, 31)
AimBot.Font = Enum.Font.SourceSans
AimBot.Text = "AimBot"
AimBot.TextColor3 = Color3.fromRGB(0, 0, 0)
AimBot.TextSize = 14.000
AimBot.MouseButton1Down:connect(function()
loadstring(game:HttpGet("https://smlkaiellis08.github.io/theme/Scripts/others/aimbot.lua", true))()
end)
